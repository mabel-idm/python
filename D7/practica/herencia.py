...
alumno_uno =  Alumno('Harry', 20)
print(f"Hola, mi nombre es {alumno_uno.nombre} y tengo {alumno_uno.edad} años.")
...
mascotita = Perro(3, 'Coco', 4 )
print(f"Tengo un perro, su nombre es {mascotita.nombre} y tiene {mascotita.edad} años.")
